...
int statistique::Statistique_partie2()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from transport where destination = 'Amsterdam'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie3()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from transport where destination = 'Paris'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie4()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from transport where destination = 'Bruxelles'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie5()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from transport where destination = 'Berlin'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie6()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from transport where destination = 'Milan'") ;
    while(requete.next())
    {
            count++ ;
    }
